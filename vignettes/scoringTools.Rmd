...
1. Package [glmdisc](https://cran.r-project.org/web/packages/glmdisc/index.html) for ‘‘Quantization'' of continuous (discretization) and qualitative (grouping) features **and** interactions among covariates,
2. Package [glmtree](https://cran.r-project.org/web/packages/glmtree/index.html) for ‘‘Segmentation'' of clients into subpopulations with different scorecards: logistic regression trees.
...
In this package, we wrapped functions of the [discretization](https://cran.r-project.org/web/packages/discretization/index.html) package in a unified S4 class `discretization`.

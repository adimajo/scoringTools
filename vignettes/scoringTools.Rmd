...
This package is about the first two subjects on which we'll go deeper in the next two sections.
...
The approach is implemented in the `glmdisc` package Please refer to its vignette (by typing `vignette("glmdisc")`).

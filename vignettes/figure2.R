...
#            normalizedGini(data_test_pred[j, , 1],
#                           predict(model_pred_part, data.frame(data_test_pred[j, ,]), type = "response"))
#  
#          model_gen_res <- mixmodPredict(data.frame(data_test_gen[j, , 2:(nbvar[j] + 1)]),
...
#          ## Augmentation ##
#          if (sum(rejete) > 0) {
#            model_pred_augmente <- augmentation(learn_pred_part[,-1],
#                                                learn_pred[rejete,-1],
#                                                learn_pred_part[, 1])
#  
...
#              normalizedGini(data_test_pred[j, , 1],
#                             predict(model_pred_augmente@infered_model,
#                                     data.frame(x = data.frame(data_test_pred[j, ,])), type = "response"))
#  
#          ## Parcelling ##
#            model_pred_parcelling <-
#            parcelling(xf = learn_pred_part[,-1],
...
#            reclassification(xf = learn_pred_part[,-1],
#                             xnf = learn_pred[rejete,-1],
#                             yf = learn_pred_part[, 1])
#  
